      ...
      <div className="min-h-screen bg-gradient-to-br from-white via-purple-50 to-blue-50 md:pt-35 pt-19">
        <main className="flex md:flex-row flex-col md:gap-30 gap-10 justify-center items-center max-w-7xl mx-auto px-4 md:px-8">
          ...
          >
            ...
            >
              The Smarter Way to Manage <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600">Appointments</span>
            </motion.h1>
            ...
            >
              Say goodbye to chaos. Bookify streamlines your booking process with an intuitive interface that clients love. From service selection to confirmation — all in seconds.
            </motion.p>
            ...
            >
              <Link to="/services" className="flex-1 md:flex-none">
                <button className="w-full md:w-auto bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-4 rounded-lg text-lg font-bold hover:shadow-lg hover:scale-105 transition duration-300 flex items-center justify-center gap-2 group">
                  Get Started <ArrowRight className="group-hover:translate-x-1 transition" size={20} />
                </button>
              </Link>
              <button className="w-full md:w-auto border-2 border-purple-600 text-purple-600 px-8 py-4 rounded-lg text-lg font-bold hover:bg-purple-50 transition duration-300">
                Learn More
              </button>
            </motion.div>
            ...
            <motion.div 
              ...
              className="flex justify-start gap-8 mt-10 md:flex-row flex-col"
            >
              <div>
